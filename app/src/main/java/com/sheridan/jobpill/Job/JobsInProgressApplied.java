...
public class JobsInProgressApplied extends AppCompatActivity implements JobsListFirestoreAdapter.OnListItemClick, FilterAlertDialog.FilterDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jobs_in_progress_applied);
        toolbar = (Toolbar) findViewById(R.id.top_toolbar_job_inprogress_applied);
        toolbar.setTitle("");
        ...
        imageView = findViewById(R.id.jobsinprogressapplied_back_button);
        ...
        recyclerView = findViewById(R.id.jobsListApplied);
    ...
    private void sendToProfile() {
        Intent intent = new Intent(JobsInProgressApplied.this, ProfileActivity.class);
        startActivity(intent);
        finish();
    }

    private void sendToHome() {
        Intent intent = new Intent(JobsInProgressApplied.this, MainActivity.class);
        startActivity(intent);
        finish();
    }

    private void sendToMyJobs() {
        Intent intent = new Intent(JobsInProgressApplied.this, JobsInProgressOptionActivity.class);
        startActivity(intent);
        finish();
    }
}
